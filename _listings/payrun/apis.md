...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/errors/master/_listings/payrun/apis.md
specificationVersion: "0.14"
apis:
- name: Pay Run.IO - Gets the error model template
  x-api-slug: templateserrormodel-get
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/errors/master/_listings/payrun/templateserrormodel-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/errors/master/_listings/payrun/templateserrormodel-get-openapi.md
- name: Pay Run.IO - Gets the error model template
  x-api-slug: templateserrormodel-get
  description: Return the error model data object template
  image: http://kinlane-productions.s3.amazonaws.com/screen-capture-api/28484-payrun-io.jpg
