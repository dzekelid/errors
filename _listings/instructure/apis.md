...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/errors/master/_listings/instructure/apis.md
specificationVersion: "0.14"
apis:
- name: Instructure Canvas Utility APIs - Create Error Report
  x-api-slug: error-reports-post
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/errors/master/_listings/instructure/error-reports-post-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/errors/master/_listings/instructure/error-reports-post-openapi.md
- name: Instructure Canvas Utility APIs - Create Error Report
  x-api-slug: error-reports-post
  description: Create error report.
  image: http://kinlane-productions.s3.amazonaws.com/screen-capture-api/820-instructure.jpg
